        ...
        <div className="container mx-auto px-8 py-4 flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="md:hidden relative flex items-center justify-center">
              ...
              {showMobileMenu && (
                <div
                  className="absolute left-0 right-0 mx-auto w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50"
                  style={{ minWidth: '12rem', top: 'calc(100% + 8px)' }}
                >
